...
router.route("/Waitlistadd").post((req, res) => {
...
router.route("/Waitlist").get((req,res)=>{
...
router.route("/Waitlistupdate/:id").put(async(req,res)=>{ //update
...
router.route("/Waitlistdelete/:id").delete(async(req,res)=>{  //delete
    let userId = req.params.id;
...
router.route("/Waitlistget/:id").get(async(req,res) => {
  try {
      let userId = req.params.id;
...
//monthly report
router.get("/Waitlistmonthly", async (req, res) => {
  try {
...
router.get("/Waitlistweekly", async (req, res) => {
  try {
...
router.route("/Waitlist").get(async (req, res) => {
  try {
...
router.post('/Waitlistsend-email', (req, res) => {
